...
// OttomanKit
#define COCOAPODS_POD_AVAILABLE_OttomanKit
#define COCOAPODS_VERSION_MAJOR_OttomanKit 0
#define COCOAPODS_VERSION_MINOR_OttomanKit 1
#define COCOAPODS_VERSION_PATCH_OttomanKit 0
